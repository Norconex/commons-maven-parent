...
if "%CHANGED_COMMITTER_GOOGLECLOUDSEARCH%"=="1" (
  set "CHANGED_IMPORTER=1"
  set "CHANGED_COMMITTER_CORE=1"
  set "CHANGED_COMMONS_MAVEN_PARENT=1"
)
if "%CHANGED_COMMITTER_ELASTICSEARCH%"=="1" (
  set "CHANGED_COMMITTER_CORE=1"
  set "CHANGED_COMMONS_MAVEN_PARENT=1"
)
...
if "%CHANGED_COMMITTER_CORE%"=="1" set "CHANGED_COMMONS_MAVEN_PARENT=1"
